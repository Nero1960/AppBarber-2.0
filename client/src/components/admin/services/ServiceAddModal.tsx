...
const ServiceAddModal = () => {
    ...
    const modal = queryParams.get('addModal');
    ...
    const handleSubmitAddService = (formData : Service) => {
        mutate({formData});
        reset;
    }
    ...
    return (
        ...
        >
            ...
            <ModalContent bg="#1f1f1f" color={'#f7f7f7'} padding={5}>
                ...
                <form
                    noValidate
                    onSubmit={handleSubmit(handleSubmitAddService)}

                >
                    <ModalBody>
                        <h2 className="text-2xl font-bold text-[#D6A354] mb-6">Agrega un nuevo Servicio</h2>
